(Concat
  ...
  (Concat
    ...
    (Concat
      (VecMAC
        (VecMul
          (Vec (Get I 7) (Get I 8) 1 (Get I 0))
          (LitVec (Get F 1) (Get F 1) 0 (Get F 2)))
        (LitVec (Get I 8) (Get I 9) (Get I 9) (Get I 10))
        (LitVec (Get F 0) (Get F 0) (Get F 1) (Get F 0)))
      (Concat
        (VecMAC
          (VecAdd
            (VecMul
        ...
        (Concat
          ...
          (Concat
            (VecMAC
              (VecAdd
                (VecMul (Vec (Get I 9) 1 1 (Get I 11)) (LitVec (Get F 2) 0 0 (Get F 2)))
                (VecMAC
                  (VecMul (Vec (Get I 18) 1 1 (Get I 20)) (LitVec (Get F 1) 0 0 (Get F 1)))
                  (LitVec (Get I 19) (Get I 9) (Get I 10) (Get I 21))
                  (LitVec (Get F 0) (Get F 3) (Get F 2) (Get F 0))))
              (LitVec (Get I 8) (Get I 19) (Get I 20) (Get I 10))
            ...
            (Concat
              ...
              (Concat
                ...
                (Concat
                  (VecMAC
                    (VecAdd
                      (VecMul (Vec 1 1 (Get I 21) (Get I 22)) (LitVec 0 0 (Get F 2) (Get F 2)))
                      (VecMAC
                        (VecMul (Vec 1 1 (Get I 30) (Get I 31)) (LitVec 0 0 (Get F 1) (Get F 1)))
                        (LitVec (Get I 19) (Get I 20) (Get I 31) (Get I 32))
                        (LitVec (Get F 3) (Get F 2) (Get F 0) (Get F 0))))
                    (LitVec (Get I 29) (Get I 30) (Get I 20) (Get I 21))
                  ...
                  (Concat
                    ...
                    (Concat
                      (VecMAC
                        (VecAdd
                          (VecMul
                            (Vec (Get I 27) (Get I 28) (Get I 29) 1)
                            (LitVec (Get F 2) (Get F 2) (Get F 2) 0))
                          (VecMAC
                            (VecMul
                              (Vec (Get I 36) (Get I 37) (Get I 38) 1)
                              (LitVec (Get F 1) (Get F 1) (Get F 1) 0))
                            (LitVec (Get I 37) (Get I 38) (Get I 39) (Get I 29))
                            (LitVec (Get F 0) (Get F 0) (Get F 0) (Get F 3))))
                        (LitVec (Get I 26) (Get I 27) (Get I 28) (Get I 39))
                      ...
                      (Concat
                          ...
                          (VecAdd
                            ...
                            (VecMAC
                              (VecMul
                                ...
                                (LitVec 0 (Get F 1) (Get F 1) (Get F 1)))
                              (LitVec (Get I 30) (Get I 41) (Get I 42) (Get I 43))
                              (LitVec (Get F 2) (Get F 0) (Get F 0) (Get F 0))))
                          (LitVec (Get I 40) (Get I 30) (Get I 31) (Get I 32))
                        ...
                        (Concat
                          ...
                          (Concat
                            (VecMAC
                              (VecAdd
                                (VecMul (Vec (Get I 38) (Get I 39) 1 1) (LitVec (Get F 2) (Get F 2) 0 0))
                                (VecMAC
                                  (VecMul (Vec (Get I 47) (Get I 48) 1 1) (LitVec (Get F 1) (Get F 1) 0 0))
                                  (LitVec (Get I 48) (Get I 49) (Get I 39) (Get I 40))
                                  (LitVec (Get F 0) (Get F 0) (Get F 3) (Get F 2))))
                              (LitVec (Get I 37) (Get I 38) (Get I 49) (Get I 50))
                            ...
                            (Concat
                              ...
                              (Concat
                                ...
                                (Concat
                                  (VecMAC
                                    (VecAdd
                                      (VecMul (Vec (Get I 49) 1 1 (Get I 51)) (LitVec (Get F 2) 0 0 (Get F 2)))
                                      (VecMAC
                                        (VecMul (Vec (Get I 58) 1 1 (Get I 60)) (LitVec (Get F 1) 0 0 (Get F 1)))
                                        (LitVec (Get I 59) (Get I 49) (Get I 50) (Get I 61))
                                        (LitVec (Get F 0) (Get F 3) (Get F 2) (Get F 0))))
                                    (LitVec (Get I 48) (Get I 59) (Get I 60) (Get I 50))
                                    (LitVec (Get F 3) (Get F 1) (Get F 0) (Get F 3)))
                                  (Concat
                                    (VecMAC
                                      (VecAdd
                                    ...
                                    (Concat
                                      ...
                                      (Concat
                                        (VecMAC
                                          (VecAdd
                                            (VecMul (Vec 1 1 (Get I 61) (Get I 62)) (LitVec 0 0 (Get F 2) (Get F 2)))
                                            (VecMAC
                                              (VecMul (Vec 1 1 (Get I 70) (Get I 71)) (LitVec 0 0 (Get F 1) (Get F 1)))
                                              (LitVec (Get I 59) (Get I 60) (Get I 71) (Get I 72))
                                              (LitVec (Get F 3) (Get F 2) (Get F 0) (Get F 0))))
                                          (LitVec (Get I 69) (Get I 70) (Get I 60) (Get I 61))
                                          (LitVec (Get F 1) (Get F 0) (Get F 3) (Get F 3)))
                                        (Concat
                                          (VecMAC
                                            (VecAdd
                                          ...
                                          (Concat
                                            (VecMAC
                                              (VecAdd
                                                (VecMul
                                                  (Vec (Get I 67) (Get I 68) (Get I 69) 1)
                                                  (LitVec (Get F 2) (Get F 2) (Get F 2) 0))
                                                (VecMAC
                                                  (VecMul
                                                    (Vec (Get I 76) (Get I 77) (Get I 78) 1)
                                                    (LitVec (Get F 1) (Get F 1) (Get F 1) 0))
                                                  (LitVec (Get I 77) (Get I 78) (Get I 79) (Get I 69))
                                                  (LitVec (Get F 0) (Get F 0) (Get F 0) (Get F 3))))
                                              (LitVec (Get I 66) (Get I 67) (Get I 68) (Get I 79))
                                              (LitVec (Get F 3) (Get F 3) (Get F 3) (Get F 1)))
                                            (Concat
                                              (VecMAC
                                                (VecAdd
                                                  ...
                                                  (VecMAC
                                                    (VecMul
                                                      ...
                                                      (LitVec 0 (Get F 1) (Get F 1) (Get F 1)))
                                                    (LitVec (Get I 70) (Get I 81) (Get I 82) (Get I 83))
                                                    (LitVec (Get F 2) (Get F 0) (Get F 0) (Get F 0))))
                                                (LitVec (Get I 80) (Get I 70) (Get I 71) (Get I 72))
                                                (LitVec (Get F 0) (Get F 3) (Get F 3) (Get F 3)))
                                              (Concat
                                                (VecMAC
                                                  (VecAdd
                                                ...
                                                (Concat
                                                  (VecMAC
                                                    (VecAdd
                                                      (VecMul (Vec (Get I 78) (Get I 79) 1 1) (LitVec (Get F 2) (Get F 2) 0 0))
                                                      (VecMAC
                                                        (VecMul (Vec (Get I 87) (Get I 88) 1 1) (LitVec (Get F 1) (Get F 1) 0 0))
                                                        (LitVec (Get I 88) (Get I 89) (Get I 79) (Get I 80))
                                                        (LitVec (Get F 0) (Get F 0) (Get F 3) (Get F 2))))
                                                    (LitVec (Get I 77) (Get I 78) (Get I 89) (Get I 90))
                                                    (LitVec (Get F 3) (Get F 3) (Get F 1) (Get F 0)))
                                                  (Concat
                                                    (VecMAC
                                                      (VecAdd
                                                    ...
                                                    (Concat
                                                      ...
                                                      (Concat
                                                        (VecMAC
                                                          (VecAdd
                                                            (VecMul (Vec (Get I 89) 1 1 1) (LitVec (Get F 2) 0 0 0))
                                                            (VecMAC
                                                              (VecMul (Vec (Get I 98) 1 1 1) (LitVec (Get F 1) 0 0 0))
                                                              (Vec (Get I 99) (Get I 89) 1 (Get I 90))
                                                              (LitVec (Get F 0) (Get F 3) 0 (Get F 3))))
                                                          (LitVec (Get I 88) (Get I 99) (Get I 90) (Get I 91))
                                                          (LitVec (Get F 3) (Get F 1) (Get F 2) (Get F 2)))
                                                        (Concat
                                                          (VecMAC
                                                            (VecMul
                                                              (LitVec (Get I 91) (Get I 92) (Get I 93) (Get I 94))
                                                          ...
                                                          (Concat
                                                            (VecMAC
                                                              ...
                                                              (LitVec (Get F 2) (Get F 2) (Get F 2) (Get F 2)))
                                                            (VecMul (LitVec (Get I 99) 0 0 0) (LitVec (Get F 3) 0 0 0))))))))))))))))))))))))))))))))
