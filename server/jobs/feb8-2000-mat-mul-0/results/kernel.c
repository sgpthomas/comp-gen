...
int __attribute__((section(".dram0.data"))) v_1[4] = {0, 1, 0, 1};
int __attribute__((section(".dram0.data"))) v_1_0[4] = {0, 1, 0, 1};
int __attribute__((section(".dram0.data"))) v_3[4] = {0, 0, 2, 2};
int __attribute__((section(".dram0.data"))) v_3_0[4] = {0, 0, 2, 2};
...
float * __restrict A_mut = A;
  ...
  xb_vecMxf32 v_2;
  v_2 = PDX_MOV_MXF32_FROM_MX32(PDX_SHFL_MX32(PDX_MOV_MX32_FROM_MXF32(B_0_4), *((xb_vecMx32 *) v_1_0)));
  xb_vecMxf32 v_4;
  v_4 = PDX_MOV_MXF32_FROM_MX32(PDX_SHFL_MX32(PDX_MOV_MX32_FROM_MXF32(A_0_4), *((xb_vecMx32 *) v_3_0)));
